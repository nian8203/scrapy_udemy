...
class MercadoLibreCrawler(CrawlSpider):
    ...
    def parse_items(self, response):
        ...
        item.add_xpath('descripcion', '//div[@class="ui-pdp-container__row ui-pdp-container__row--description"]/p/text()', MapCompose(lambda i: i.replace('\n', ' ').replace('\r', ' ').strip()))

        soup = BeautifulSoup(response.body)
        precio = soup.find(class_="ui-pdp-price__second-line")
